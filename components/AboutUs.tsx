...
const pillars = [
  {
    ...
    body:   'Çatdırılma haqqı almırıq — nə Bakıda, nə Sumqayıtda, nə də ölkənin hər hansı guşəsində. Kuryer, metro görüşü, Azərpoçt — üç kanal, hamısı ödənişsiz. Çünki bir hədiyyə seçib sonra çatdırılma haqqıyla üzləşmək həmin hədiyyənin sevincini əlindən alır.',
    stats:  [{ val: '3', unit: 'çatdırılma kanalı' }, { val: '0₼', unit: 'çatdırılma haqqı' }],
  },
  {
    icon:   '🐾',
    color:  '#0f2a1e',
    ...
    body:   'Hər aldığın hədiyyənin 5%-i avtomatik olaraq küçə heyvanlarının yemlənməsinə, müalicəsinə və sığınacağına yönəlir. Bu şərt deyil, reklam deyil — biznesmizin quruluşuna işlənmiş bir öhdəlikdir. Sənin sevdiyinə hədiyyə alarkən bir başqasına da yaxşılıq etmiş olursan.',
    stats:  [{ val: '5%', unit: 'hər satışdan' }, { val: '♾', unit: 'davamlı öhdəlik' }],
  },
  {
    icon:   '✍️',
    color:  '#1a1200',
    ...
    body:   'Lazer texnologiyası ilə hər məhsula ad, tarix, mesaj, hətta koordinat yazırıq. Satın aldığın əşya mağazadan deyil, sənin ürəyindən gəlmiş kimi görünür. Kütləvi istehsal yoxdur — hər sifariş ayrıca hazırlanır, ayrıca yoxlanılır, ayrıca paketlənir.',
    stats:  [{ val: '1–3', unit: 'gün ərzində hazır' }, { val: '100%', unit: 'fərdi hazırlıq' }],
  },
];
      ...
      <div style={{ background: C.white, padding: 'clamp(40px,6vw,80px) clamp(20px,5vw,48px)' }}>
        <div style={{ maxWidth: 720, margin: '0 auto' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column' as const, gap: 0 }}>
            {steps.map((step, i) => (
              <div key={step.n} style={{ display: 'flex', gap: 20, alignItems: 'flex-start', paddingBottom: i < steps.length - 1 ? 28 : 0 }}>
