            ...
            <div key={product.id} onClick={() => onViewProduct(product)}
              ...
              <div className="relative aspect-square bg-white">
                ...
                <button onClick={(e) => { e.stopPropagation(); onAddToCart(product); }}
                  className="absolute bottom-3 right-3 bg-white p-2.5 rounded-full shadow-lg opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300 hover:bg-[#FF8C00] hover:text-white z-20">
